...
import {createAccount, getAccounts, deleteAccount, ModifyAccount, createContract, getContracts,CreateMandateForContract, CreateMandate, payment} from '../../services/merchantServices/merchantSerives'  ;
...
export const createPayment = async (req: Request, res: Response) => {
    const paymentIntiation = await payment(req.body);
