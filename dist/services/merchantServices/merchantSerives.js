...
const userPaymentAccountModel_1 = require("../../model/userPaymentAccountModel");
const adressModel_1 = require("../../model/adressModel");
const bankAccountDeatilModel_1 = require("../../model/bankAccountDeatilModel");
const contractModel_1 = require("../../model/contractModel");
...
function createAccount(account) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const addressRecord = yield adressModel_1.Address.create(address);
            const bankDetailsRecord = yield bankAccountDeatilModel_1.BankDetails.create(bankDetails);
            const newAccount = yield userPaymentAccountModel_1.Account.create(Object.assign(Object.assign({}, accountDetails), { addressUId: addressRecord.id, bankDetailsUId: bankDetailsRecord.id }));
            if (newAccount) {
                return newAccount;
            }
        }
...
function getAccountById(id) {
    return __awaiter(this, void 0, void 0, function* () {
        const account = yield userPaymentAccountModel_1.Account.findByPk(id, {
            include: [adressModel_1.Address, bankAccountDeatilModel_1.BankDetails],
        });
        return account;
    });
}
...
function getAccounts() {
    return __awaiter(this, void 0, void 0, function* () {
        const users = yield userPaymentAccountModel_1.Account.findAll();
        return users;
    });
}
exports.getAccounts = getAccounts;
const getAddressById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    return yield adressModel_1.Address.findByPk(id);
});
exports.getAddressById = getAddressById;
const GetBankAccountById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    return yield bankAccountDeatilModel_1.BankDetails.findByPk(id);
});
...
function ModifyAccount(accountData) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const account = yield userPaymentAccountModel_1.Account.findByPk(accountData.id);
        if (!account)
            throw new Error('Account not found');
        if (address) {
            const addressRecord = yield adressModel_1.Address.findByPk(account.addressUId);
            if (addressRecord) {
                yield addressRecord.update(address);
            }
        }
        if (bankDetails) {
            const bankDetailsRecord = yield bankAccountDeatilModel_1.BankDetails.findByPk(account.bankDetailsUId);
...
function deleteAccount(id) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const accountEntity = yield userPaymentAccountModel_1.Account.findByPk(id);
            if (!accountEntity) {
...
function payment(data) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (islogin) {
                const book = yield bookModel_1.Book.findByPk(data.bookId);
                if (book) {
                    ...
                    if (payment) {
                        const userAllOrder = yield paymentModel_1.Payment.update({ status: 'Initiating' }, {
                            where: {
                                userId: islogin.id,
                                bookId: data.bookId
                            }
...
//# sourceMappingURL=merchantSerives.js.map