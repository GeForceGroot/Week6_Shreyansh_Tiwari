...
const merchantController_1 = require("../../controller/merchantController/merchantController");
...
merchantRoutes.post('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const accountAdded = yield (0, merchantController_1.addAccount)(req, res);
    res.send(accountAdded);
}));
merchantRoutes.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const accountAdded = yield (0, merchantController_1.getAccount)(req, res);
    res.send(accountAdded);
}));
merchantRoutes.put('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const accountAdded = yield (0, merchantController_1.updateAccount)(req, res);
    res.send(accountAdded);
}));
merchantRoutes.delete('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const accountAdded = yield (0, merchantController_1.removeAccount)(req, res);
    res.send(accountAdded);
}));
merchantRoutes.post('/contract', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const accountAdded = yield (0, merchantController_1.addContract)(req, res);
    res.send(accountAdded);
}));
merchantRoutes.get('/contract', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const accountAdded = yield (0, merchantController_1.getContract)(req, res);
    res.send(accountAdded);
}));
merchantRoutes.get('/mandate', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const accountAdded = yield (0, merchantController_1.createMandateFlowForAllContracts)(req, res);
    res.send(accountAdded);
}));
merchantRoutes.post('/payment', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const paymentstatus = yield (0, merchantController_1.createPayment)(req, res);
