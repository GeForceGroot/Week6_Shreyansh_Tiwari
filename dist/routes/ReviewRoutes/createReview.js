...
const writeReviewController_1 = require("../../controller/ReviewController/writeReviewController");
...
writeReviewRoute.post('/book/:id?', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const newReview = yield (0, writeReviewController_1.createNewReview)(req, res, id);
        return newReview;
    }
    catch (error) {
