...
const assignRatingController_1 = require("../../controller/ratingController/assignRatingController");
...
ratingRoute.post('/:id?', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const rating = yield (0, assignRatingController_1.assignNewRating)(req, res, id);
        return rating;
    }
    catch (error) {
...
//# sourceMappingURL=giveRatingRoute.js.map