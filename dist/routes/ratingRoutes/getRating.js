...
const getRatingController_1 = require("../../controller/ratingController/getRatingController");
...
getAllRatingRoute.get('/:id?', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const allReview = yield (0, getRatingController_1.getAllRating)(req, res, id);
        return allReview;
    }
    catch (error) {
