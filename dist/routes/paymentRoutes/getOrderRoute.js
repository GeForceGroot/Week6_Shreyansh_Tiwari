...
const getOrderController_1 = require("../../controller/paymentController/getOrderController");
...
getOrderRoute.get('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const orders = yield (0, getOrderController_1.getOrders)(req, res, id);
        return orders;
    }
    catch (error) {
...
//# sourceMappingURL=getOrderRoute.js.map