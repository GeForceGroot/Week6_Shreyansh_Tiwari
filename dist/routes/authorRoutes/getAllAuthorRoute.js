...
const getAllAuthorController_1 = require("../../controller/authorController/getAllAuthorController");
...
getAllAuthorRoute.get('/:id?', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const allAuthor = yield (0, getAllAuthorController_1.getAllAuthor)(req, res, id);
        return allAuthor;
    }
    catch (error) {
...
//# sourceMappingURL=getAllAuthorRoute.js.map