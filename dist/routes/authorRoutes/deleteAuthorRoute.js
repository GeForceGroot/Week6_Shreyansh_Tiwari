...
const deleteAuthController_1 = require("../../controller/authorController/deleteAuthController");
...
deleteAuthorRoute.delete('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const update = yield (0, deleteAuthController_1.authorDelete)(req, res, id);
        return update;
    }
    catch (error) {
...
//# sourceMappingURL=deleteAuthorRoute.js.map