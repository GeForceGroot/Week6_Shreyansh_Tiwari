...
const createAuthorController_1 = require("../../controller/authorController/createAuthorController");
...
cretaAuthorRoute.post('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const newAuthor = yield (0, createAuthorController_1.createNewAthor)(req, res);
        return newAuthor;
    }
    catch (error) {
...
//# sourceMappingURL=createAuthorRoute.js.map