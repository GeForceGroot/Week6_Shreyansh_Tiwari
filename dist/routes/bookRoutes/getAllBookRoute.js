...
const getAllBookController_1 = require("../../controller/bookConroller/getAllBookController");
...
getAllBooksRoute.get('/:id?', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const allBook = yield (0, getAllBookController_1.getAllBook)(req, res, id);
        return allBook;
    }
    catch (error) {
...
//# sourceMappingURL=getAllBookRoute.js.map